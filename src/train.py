...
def main():
    """Main function to train the model and log with MLflow."""
    ...
    with mlflow.start_run() as run:
        ...
        # --- FIX: Log the model with an input example and explicit name ---
        input_example = X_train.head()
        mlflow.xgboost.log_model(
            xgb_model=model,
            name="xgboost-ltv-model", # Use 'name' instead of 'artifact_path'
            input_example=input_example # Provide an input example to infer the signature
        )
